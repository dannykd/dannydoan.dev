...
const Experience = ({ img, role, timespan, description }: ExperienceProps) => {
    ...
    return (
        <div className="dark:bg-[#000000] bg-white rounded-lg border dark:border-neutral-400 border-black/20 px-2 p-4">
            <div className="flex space-x-4 border-b border-black/20 dark:border-neutral-400 px-2">
