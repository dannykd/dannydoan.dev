...
const Experience = ({ img, role, timespan, description }: ExperienceProps) => {
    ...
    return (
        <div className="dark:bg-[#0b0b0b] bg-white rounded-lg border dark:border-white/20 border-black/20 px-2 p-4
        hover:shadow-md hover:shadow-blue-500 transition duration-200 ease-out md:ease-in">
